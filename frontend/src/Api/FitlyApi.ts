...
class FitlyApi {
	...
	static async findAllWorkouts<Promise>(data: WorkoutData): Promise {
        console.log(data)
	...
	static async addWorkoutCircuit<Promise>(data: {
	...
	static async updateCategory<Promise>(data: { categoryId: number; name: string; description: string }): Promise {
	...
	static async addExerciseCircuit<Promise>(data: {
		circuitId: number | undefined;
	...
	static async updateExerciseCircuit<Promise>(data: {
		circuitId: number | undefined;
		exerciseId: number | undefined;
	}): Promise {
