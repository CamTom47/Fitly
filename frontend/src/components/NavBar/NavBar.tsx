    ...
    ?   <div className="NavBarContainer">
                <div className="NavBarHeader">
                    ...
                    <div className="NavBarBody offScreen">
                        ...
                        <Link className="NavBarLink"  to="/exercises" onClick={handleToggle}>Exercises</Link>    
                        <Link className="NavBarLink"  to="/workouts" onClick={handleToggle}>Workouts</Link>    
                        <Link className="NavBarLink" onClick={handleLogOut}  to="/">Sign Out</Link>
                    </div>
        </div>
