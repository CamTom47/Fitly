                        ...
                        <div className="FormContainerInner">
                            ...
                            <Form className="FormContentInput">
                                    <div className="FormContentInputDiv">
                                        ...
                                        <Field className="FormInput" type='password' name='currentPassword'/>
                                    </div>
                                    <div style={{color: "red"}}>
                                    ...
                                    <div className="FormContentInputDiv">
                                        ...
                                        <Field className="FormInput" type='password' name='newPassword'/>
                                    </div>
                                    <div style={{color: "red"}}>
                                    ...
                                    <div className="FormContentInputDiv">
                                        ...
                                        <Field className="FormInput" type='password' name='confirmedPassword'/>
                                    </div>
                                    <div style={{color: "red"}}>
                                        <ErrorMessage name='confirmedPassword' component='div'/>
                                    </div>
                                    <div className="FormContentInputDiv">
                                        <button className="FormButton" onClick={handleUserPasswordToggle}>Cancel</button>
