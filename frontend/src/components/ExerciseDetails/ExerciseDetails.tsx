...
const ExerciseDetails = ({
  ...
  const handleEditClick = () => {
    setToggleExerciseUpdateForm(
      (toggleExerciseUpdateForm) => !toggleExerciseUpdateForm
    );
  };
