...
export const findAllEquipments = createAsyncThunk("equipments/findAllEquipments", async () => {
	try {
...
export const findAEquipment = createAsyncThunk("equipments/findAEquipment", async (equipmentId: number) => {
	try {
...
export const addEquipment = createAsyncThunk("equipments/equipmentAdded", async (data: Equipments) => {
	try {
...
export const updateEquipment = createAsyncThunk("equipments/equipmentUpdated", async (exerciseId: number, data) => {
	try {
...
export const deleteEquipment = createAsyncThunk("equipments/equipmentDelete", async (equipmentId: number) => {
	try {
